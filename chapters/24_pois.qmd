...
```{r, echo=FALSE}
curve(dpois(x, lambda=1), from=0,to=20,n=21,col=1,type='b',ann=F)
curve(dpois(x, lambda=4), from=0,to=20,n=21,col=2,type='b',ann=F,add=T)
curve(dpois(x, lambda=10), from=0,to=20,n=21,col=3,type='b',ann=F,add=T)
