...
(PDF) of $X$ is a real-valued function $f:\mathbb{R}\to[0,\infty)$ such that
...
1.  Define $X$ = "the student’s elevator waiting time." 
...
4.  If the student must wait more than 2 minutes, they decide to take
    ...
    $Y$, which equals $1$ if $X>2$ and $0$ otherwise. Compute $P(Y=1)$.
:::
