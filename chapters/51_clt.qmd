...
::: callout-note
### Distributuion of $\bar{X}$ vs Distribution of $X$
The distribution of the sample mean $\bar{X}$ and the distribution of the 
random variables $X_i$ are fundamentally different. 
The former is a theoretical distribution of the averages we would get if 
we drew repeated samples of size $n$. 
What the CLT says is that, regardless the distribution of $X_i$, the 
distribution of $\bar{X}$ always approaches Normal. 
:::
