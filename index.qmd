...
<input id="exam-lookup-input" type="text" inputmode="numeric" placeholder="e.g. 42431000" aria-describedby="exam-lookup-status">
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      loadError = error;
      status.textContent = 'Exam score lookup is unavailable.';
  ...
  const renderResult = (record, query) => {
    ...
    headers.forEach((header) => {
      ...
      td.textContent = value !== undefined && value !== '' ? value : '0';
